...
Changes in the API are planned e.g. to correct some object namings and there are still known but not fixed bugs and sign-definition problems. This software is implemented for learning purposes only. It is not recommended to use it as as an GA-implementation for application development.
